/* 修改自 shaolin-kongfu，本脚本执行lookstartbody末尾num指定值之body个数，请修改变量值以改变个数 */

let num=5   //  ##修改此处num值以执行末尾几个body，num=5：末尾5个body##
...
!(async () => {
    ...
    else
    {
        ...
        for(let i=jctqLookStartbodyArr.length-num; i<jctqLookStartbodyArr.length; i++) {
